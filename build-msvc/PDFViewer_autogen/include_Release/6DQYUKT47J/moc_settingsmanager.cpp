...
void SettingsManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->settingsApplied((*reinterpret_cast<std::add_pointer_t<AppSettings>>(_a[1]))); break;
        case 1: _t->settingChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QVariant>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SettingsManager::*)(const AppSettings & )>(_a, &SettingsManager::settingsApplied, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SettingsManager::*)(const QString & , const QVariant & )>(_a, &SettingsManager::settingChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void SettingsManager::settingsApplied(const AppSettings & _t1)
{
