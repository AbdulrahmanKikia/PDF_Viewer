...
void TabManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->tabCountChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 3: _t->tabTitleChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        case 4: _t->tabDirtyChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        ...
        case 7: _t->onTabContextMenuRequested((*reinterpret_cast<std::add_pointer_t<QPoint>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TabManager::*)(int )>(_a, &TabManager::tabChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TabManager::*)(int )>(_a, &TabManager::tabClosed, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (TabManager::*)(int )>(_a, &TabManager::tabCountChanged, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (TabManager::*)(int , const QString & )>(_a, &TabManager::tabTitleChanged, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (TabManager::*)(int , bool )>(_a, &TabManager::tabDirtyChanged, 4))
            return;
    }
}
...
// SIGNAL 0
void TabManager::tabChanged(int _t1)
{
...
// SIGNAL 2
void TabManager::tabCountChanged(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 2, nullptr, _t1);
}

// SIGNAL 3
void TabManager::tabTitleChanged(int _t1, const QString & _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 3, nullptr, _t1, _t2);
}

// SIGNAL 4
void TabManager::tabDirtyChanged(int _t1, bool _t2)
{
