...
template <> constexpr inline auto FilePropertiesDialog::qt_create_metaobjectdata<qt_meta_tag_ZN20FilePropertiesDialogE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<FilePropertiesDialog, qt_meta_tag_ZN20FilePropertiesDialogE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject FilePropertiesDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN20FilePropertiesDialogE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN20FilePropertiesDialogE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN20FilePropertiesDialogE_t>.metaTypes,
    nullptr
} };
...
void *FilePropertiesDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN20FilePropertiesDialogE_t>.strings))
