...
#include "../../../../src/ui/advancedsearchdialog.h"
...
template <> constexpr inline auto AdvancedSearchDialog::qt_create_metaobjectdata<qt_meta_tag_ZN20AdvancedSearchDialogE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const SearchQuery &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'onDateFilterChanged'
        QtMocHelpers::SlotData<void(int)>(5, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 6 },
        }}),
        // Slot 'onSizeFilterChanged'
...
void AdvancedSearchDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->searchRequested((*reinterpret_cast<std::add_pointer_t<SearchQuery>>(_a[1]))); break;
        case 1: _t->onDateFilterChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->onSizeFilterChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AdvancedSearchDialog::*)(const SearchQuery & )>(_a, &AdvancedSearchDialog::searchRequested, 0))
            return;
    }
}
...
// SIGNAL 0
void AdvancedSearchDialog::searchRequested(const SearchQuery & _t1)
{
